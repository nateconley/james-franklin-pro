...
function james_theme_styles() {
	...
	wp_enqueue_style( 'lightbox.css', 'http://cdnjs.cloudflare.com/ajax/libs/fotorama/4.6.4/fotorama.css' );
	wp_enqueue_style( 'google_fonts.css', 'https://fonts.googleapis.com/css?family=Lato:400,700|Roboto:400,700' );
...
function james_theme_js() {
	wp_enqueue_script( 'lightbox.js', 'http://cdnjs.cloudflare.com/ajax/libs/fotorama/4.6.4/fotorama.js', array('jquery'), '', true );
